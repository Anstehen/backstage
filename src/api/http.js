...
// get 方法：通过定义一个 get 函数，get 函数有两个参数，第一个参数表示要请求的 url 地址，第二个参数是要携带的请求参数。get 函数返回一个 promis 对象，当 axios 其请求成功时 resolve 服务器返回值，请求失败时 reject 错误值。最后通过 export 抛出 get 函数。
/** 
 * get 方法，对应 get 请求
